...
def login():
    r = requests.post("http://music.foggyio.uk:8087/api/v1/bot/login", data={"username":"automation", "password":"", "botId":"d3170c67-312a-4093-98bb-e213696d58a4"}, timeout=10.0)
...
def playing():
    try:
        ...
        r = requests.get("http://music.foggyio.uk:8087/api/v1/bot/i/a2a47bec-f1a3-4e91-85e2-eea4fa982b05/status", headers=headers, timeout=10.0)
